...
cd = pandas.read_csv("datosJuegoLimpio.csv")
...
graficaMarcas.savefig("Cantidad de juegos por marca (pastel).png")
...
cd_plataformas.plot.savefig("Cantidad de juegos por consola (barras).png")
plt.clf()
...
p_cd = pandas.read_csv("popularidad.csv")
...
for consola in consolasLimpias:
    ...
    cd_temp.savefig("Top 10 juegos de "+str(consola)+" (Lineas).png")
    cd_tem.pop("nombre")
...
plt_tem.savefig("Puntuaciones medias dadas por los usuarios (histograma).png")
...
plt_tem.set_figheight(15)
plt_tem.set_figwidth(15)
plt_tem.savefig("Plataforma y puntuacion promedio de usuarios(caja de bigotes).png",format='png', dpi=150)
