...
print("Cantidad de usuarios MEDIA que dieron una puntuacion a un juego: ", end="")
print(int(cd["numero usuarios"].mean()))
...
cd_popularidad.to_csv("popularidad.csv")
print("\n")
...
cd_plataformas.to_csv("plataformas.csv")
print("\n")
...
cd_juegos_marcas.to_csv("juegos_marcas.csv")
print("\n")
...
cd_marcas_popularidad.to_csv("popularidad.csv")
...
cd_SONY_NINTENDO.to_csv("puntaje_SONY_NINTENDO.csv")
